...
""" DEVELOPER NOTES:
* This is our mocked DB - we are using python global
* variables to simulate an actual DB
"""
...
"""
Bluebutton SDK dictionary returned from the generate_auth_data()
method is stored in DBcodeChallenges using the STATE as the key.
"""
DBcodeChallenges = {"": None}
DBid = 1
